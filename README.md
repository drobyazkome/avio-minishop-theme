...
Версия 1.5.2: компактный экран оплаты, увеличенные цены, акцент на годовом тарифе,
анимация выбранных элементов и надёжные абсолютные пути ко всем ассетам темы.

...
Версия 1.5.7: возврат к тарифам больше не накладывается на окно — компактная
стрелка находится в одной строке с названием выбранного тарифа. Параметры
тарифа отцентрированы, а длинные подписи отображаются без обрезания.

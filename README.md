...
Версия 1.5.6: новая иконка открытого замка для неактивной подписки, зелёная
карточка статуса серверов и отдельный золотой стиль тарифа «Премиум».
Возврат к списку закреплён слева в шапке диалога, сводка тарифа перестроена в
три компактных столбца, а на высокой мобильной главной убран лишний скролл.

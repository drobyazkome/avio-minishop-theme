...
Версия 1.5.5: красное состояние неактивной подписки с новой иконкой, зелёное
выделение годового периода, заметный выбранный тариф и читаемый статус серверов.
Возврат к списку снова прокручивается вместе с содержимым, сводка лимитов и
редактор тарифа стали компактнее и удобнее на узком экране.

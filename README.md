...
Версия 1.5.4: заметное состояние неактивной подписки, анимированные кнопки оплаты,
подключения устройства и продления. Продление выделено светло-зелёным цветом.
В списке тарифов увеличен текст и визуально поднят текущий второй тариф «Премиум»;
детальная карточка тарифа стала компактнее, а возврат к списку перенесён к крестику.

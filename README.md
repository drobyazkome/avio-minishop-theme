...
Версия 1.5.3: верх оплаты стал компактнее, карточки периодов ниже, кнопка оплаты
перенесена перед способом оплаты и промокодом, получила новую иконку и мягкую
анимацию. Настройка лимитов тарифа теперь подписана, а анимация нижней навигации
не смещает крайние кнопки. Годовой тариф остаётся визуально выделенным.

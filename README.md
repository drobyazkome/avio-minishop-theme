...
Версия 1.5.13: единый значок открытого замка используется для неактивной
подписки на главной и на экране устройств. Сохранены компактный блок тарифа,
фоновые изображения, локальные иконки приложений и адаптивная сетка без наложений.

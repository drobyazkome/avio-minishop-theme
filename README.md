...
Версия 1.5.0: облегчённая типографика окна оплаты, более спокойный информационный
блок и карточки периодов с чёткой иерархией срока, цены и стоимости за месяц.

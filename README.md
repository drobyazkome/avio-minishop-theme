...
Версия 1.5.14: стартовый экран сайта использует панорамный фон темы, увеличенный
логотип Avio с плашкой VPN и компактную шапку без дублирующего названия сервиса.
Форма входа остаётся читаемой на десктопе и мобильных экранах.

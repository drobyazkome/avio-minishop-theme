...
Версия 1.5.1: единая читаемая типографика на главной, в поддержке, настройках,
устройствах и бонусах. Длинные подписи переносятся без обрезания на узких экранах.

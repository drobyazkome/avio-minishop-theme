...
Версия 1.5.8: уменьшена пустая зона шапки детального тарифа, подписи и значения
трёх параметров выровнены по общей сетке. Экран смены тарифа получил те же
размеры текста, карточки и заметное состояние выбора, что основной каталог.

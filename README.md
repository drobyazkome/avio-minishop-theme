...
Версия 1.5.9: исправлена совместимость сетки параметров с production Core —
подпись и значение каждого параметра находятся в отдельных строках без наложения.
Пустая шапка продления сжата, а крестик явно закреплён справа.
